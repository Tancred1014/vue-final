<template>
  <div class="container">
    <div class="my-3 form-row text-center">
      ...
      <div class="col-12 col-sm">
        <div class="alert alert-primary alert-rounded" role="alert">2.金流付款</div>
      </div>
      <div class="col-12 col-sm">
        <div class="alert alert-light alert-rounded" v-if="!order.is_paid" role="alert">3.完成</div>
        <div class="alert alert-primary alert-rounded" v-else role="alert">3.完成</div>
      </div>
    </div>
