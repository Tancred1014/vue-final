      ...
      <div class="modal-dialog modal-sm" role="document">
        <div class="modal-content border-0">
          <div class="modal-footer">
            ...
            <button type="button" class="btn btn-primary" @click="deleteCoupon">確認刪除</button>
          </div>
        </div>
      </div>
    </div>
...
export default {
  ...
  methods: {
    ...
    deleteCoupon() {
      const vm = this;
      const api = `${process.env.VUE_APP_API}/api/${process.env.VUE_APP_CUSTOMAPI}/admin/coupon/${vm.tempProduct.id}`;
      console.log(api);
    ...
    getCoupons() {
      const vm = this;
      const url = `${process.env.VUE_APP_API}/api/${process.env.VUE_APP_CUSTOMAPI}/admin/coupons`;
      vm.isLoading = true;
    ...
    updateCoupon() {
      const vm = this;
      if (vm.isNew) {
        const url = `${process.env.VUE_APP_API}/api/${process.env.VUE_APP_CUSTOMAPI}/admin/coupon`;
        ...
        const url = `${process.env.VUE_APP_API}/api/${process.env.VUE_APP_CUSTOMAPI}/admin/coupon/${vm.tempCoupon.id}`;
