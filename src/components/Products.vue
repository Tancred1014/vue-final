...
export default {
  ...
  methods: {
    getProducts(page = 1) {
      const api = `${process.env.VUE_APP_API}/api/${process.env.VUE_APP_CUSTOMAPI}/admin/products?page=${page}`;
      const vm = this;
      vm.isLoading = true;
    ...
    delProduct() {
      const vm = this;
      const api = `${process.env.VUE_APP_API}/api/${process.env.VUE_APP_CUSTOMAPI}/admin/product/${vm.tempProduct.id}`;
      console.log(api);
    ...
    uploadFile() {
      ...
      const url = `${process.env.VUE_APP_API}/api/${process.env.VUE_APP_CUSTOMAPI}/admin/upload`;
